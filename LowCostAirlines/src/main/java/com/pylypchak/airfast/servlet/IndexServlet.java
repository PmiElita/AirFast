...
public class IndexServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			setFromSearchAttributes(request, airportFromId, cityFromId,
					countryFromId);
	...
	private void setFromSearchAttributes(HttpServletRequest request,
		...
		fillRequestAtributes(request, countryFrom, cityFrom, airportFrom,
				"From");
	...
	private void setToSearchAttributes(HttpServletRequest request,
		...
		fillRequestAtributes(request, countryTo, cityTo, airportTo, "To");
